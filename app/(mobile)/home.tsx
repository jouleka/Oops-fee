...
export default function HomeScreen() {
  ...
  // Note: Username is now auto-generated by DB trigger (migration 018)
  // No need to redirect to setup-username on login - users can change it in profile if desired
